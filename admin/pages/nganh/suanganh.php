<?php
    ...
    if(isset($_POST['ma']) && isset($_POST['ten'])){
                ...
                $tennganh = $_POST['ten'];
               // echo $maCC . " - " . $tenCC;
                $sql2="update nganh set tennganh = '$tennganh' where manganh = '$manganh'";
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="input-group">
                            mã ngành: <input class="input--style-1" type="text" name="ma" required="required" readonly="true" value="<?=$manganh?>">
                        </div>
                        <div class="input-group">
                            tên ngành: <input class="input--style-1" type="text" placeholder="nhập tên ngành" name="ten"required="required"  value="<?=$row[1]?>">
                        </div>
