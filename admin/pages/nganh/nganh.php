            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="nganh.php"><i class="fa fa-edit fa-fw"></i> quản lý ngành</a>
                        </li>
                        <li>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            quản lý ngành <a href="themnganh.php"><button class="login100-form-btn pull-right" name="btnthem" >thêm</button></a>
                        </div>
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    <?php
                                    $nganh = Nganh();
                                    while($row_nganh = mysqli_fetch_array($nganh))
                                    {
                                        ob_start();
                                ?>
                                    <tr class="odd gradeX">
                                        <td>{ma}</td>
                                        <td>{ten}</td>
                                        <td><a href="suanganh.php?manganh={ma}&tennganh={ten}"><button class="login100-form-btn" name="btnsua" >sửa</button></a> <a href="xoanganh.php?manganh={ma}"><button class="login100-form-btn" name="btnxoa" >xóa</button></a></td>
                                    </tr>
                                    <?php
                                      $s = ob_get_clean();
                                      $s = str_replace("{ma}",$row_nganh['manganh'],$s);
                                      $s = str_replace("{ten}",$row_nganh['tennganh'],$s);
                                      echo $s;
                                    }
                                    ?>
                                </tbody>
