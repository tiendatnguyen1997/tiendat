            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="CV.php"><i class="fa fa-edit fa-fw"></i> quản lý CV</a>
                        </li>
                        <li>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                ?>
                                    <tr class="odd gradeX">
                                        <td><a href="chitietCV.php?macv={macv}">{macv}</a></td>
                                        <td>{ten}</td>
                                        <td>{ngaytao}</td>
                                        <td>{trangthai}</td>
                                        <td><a href="duyet.php?macv={macv}"><button class="login100-form-btn" name="btnsua" >Duyệt</button></a> <a href="xoaCV.php?macv={macv}"><button class="login100-form-btn" name="btnxoa" >Khóa</button></a></td>
                                    </tr>
                                    <?php
                                      $s = ob_get_clean();
                                      $s = str_replace("{macv}",$row_cv['macv'],$s);
                                      $s = str_replace("{ten}",$row_cv['ten'],$s);
                                      $s = str_replace("{ngaytao}",$row_cv['ngaytao'],$s);
                                      $s = str_replace("{trangthai}",$row_cv['trangthai'],$s);
                                      echo $s;
                                    }
                                    ?>
                                </tbody>
