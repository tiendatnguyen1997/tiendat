<?php
    ...
    if(isset($_POST['ma']) && isset($_POST['ten'])){
                ...
                $tenVB = $_POST['ten'];
               // echo $maCC . " - " . $tenCC;
                $sql2="update vanbang set tenVB = '$tenVB' where maVB = '$maVB'";
                $result = mysqli_query($ketnoi, $sql2);
                header("location: vanbang.php");
        
    }

        $sql = "select * from vanbang where maVB ='$maVB'";
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="input-group">
                            mã văn bằng: <input class="input--style-1" type="text" name="ma" required="required" readonly="true" value="<?=$maVB?>">
                        </div>
                        <div class="input-group">
                            tên văn bằng: <input class="input--style-1" type="text" placeholder="nhập tên" name="ten"required="required"  value="<?=$row[1]?>">
                        </div>
