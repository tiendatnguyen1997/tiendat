	...
	<section id="page">
		<div class="container">
			<div class="row">
					...
					<div class="control-box">
						<a href="#">
							<div class="left-box">
								...
								<p class="desc-box">
									Tạo hồ sơ để nhà tuyển dụng nhìn thấy
								</p>
							</div>
							<div class="right-box">
								<div class="icon-box">
				...
				<div class="col-md-4 col-sm-6 col-xs-12">
					<div class="control-box">
						<a href="congty/index.php">
							<div class="left-box">
								<h3 class="title">
									Đăng tin tuyển dụng
								</h3>
								<p class="desc-box">
									Tiếp cận trăm nghìn người tìm việc
								</p>
							</div>
							<div class="right-box">
								<div class="icon-box">
		...
		<div class="container">
			<h1 class="primary-title">Công việc mới</h1>
			<hr>
			<div class="job">
				<?php
					include("include/laydscongviec.php");
				?>
			</div>
		</div>
	</section>
