    ...
    if($_SERVER['REQUEST_METHOD']== 'POST'){
        //echo "<pre>"; print_r($_POST);
          ...
          //  $sm= postIndex("btn_submit");
           $sql="insert into thanhvien ( email, pass, ten, sdt) value('$email', '$pw', '$name', '$SDT')";
            $o->query($sql);
            //echo $sql; exit;
                ...
                <div class="card-body">
                    ...
                    <form actor="index.php" method="POST">
                        <div class="input-group">
                            <input class="input--style-1" type="text" placeholder="email" name="email" required="required">
                        </div>
                        <div class="input-group">
                            <input class="input--style-1" type="text" placeholder="pass" name="pw">
                        </div>
                        <div class="input-group">
                            <input class="input--style-1" type="text" placeholder="Tên" name="name">
                        </div>
                        <div class="input-group">
                            <input class="input--style-1" type="SDT" placeholder="số điện thoại" name="SDT"  >
                        </div>
